...
public class Box1280Page2 extends Fragment {
    ...
    public View onCreateView(
        ...
        View v = inflater.inflate(R.layout.box1280page2, parent, false);

        box1195ViewpagerAdapter =
                new Box1195ViewpagerAdapter(
                        Box1280Page2.this.getActivity().getSupportFragmentManager());
        ...
        daoRepository = DaoRepositoryFactory.getInstance(Box1280Page2.this.getActivity());
        localStorage = LocalStorage.getInstance(Box1280Page2.this.getActivity());
        navigationController = new NavigationController(Box1280Page2.this.getActivity());
        constraintlayout00 = (ConstraintLayout) v.findViewById(R.id.constraintlayout00);
        box1290 = (ImageView) v.findViewById(R.id.box1290);
