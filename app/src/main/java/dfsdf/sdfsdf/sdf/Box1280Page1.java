...
public class Box1280Page1 extends Fragment {
    ...
    public View onCreateView(
        ...
        View v = inflater.inflate(R.layout.box1280page1, parent, false);

        box1195ViewpagerAdapter =
                new Box1195ViewpagerAdapter(
                        Box1280Page1.this.getActivity().getSupportFragmentManager());
        ...
        daoRepository = DaoRepositoryFactory.getInstance(Box1280Page1.this.getActivity());
        localStorage = LocalStorage.getInstance(Box1280Page1.this.getActivity());
        navigationController = new NavigationController(Box1280Page1.this.getActivity());
        constraintlayout00 = (ConstraintLayout) v.findViewById(R.id.constraintlayout00);
        box1289 = (ImageView) v.findViewById(R.id.box1289);
