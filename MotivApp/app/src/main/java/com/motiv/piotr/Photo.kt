...
public class Photo {
    ...
    @ColumnInfo(name = "resultOwnerId")@ForeignKey(entity = com.motiv.piotr.PhotosListResponse::class, parentColumns = ["id"], childColumns = ["resultOwnerId"])
    private
    var resultOwnerId: String = ""
    @ColumnInfo(name = "linksId")@ForeignKey(entity = com.motiv.piotr.Links::class, parentColumns = ["id"], childColumns = ["linksId"])
    private
    var linksId: String = ""
