...
public interface UserResponseDao {
    ...
    @Insert
    public fun saveUserResponse(userResponse: com.motiv.piotr.UserResponse): Long@Delete
    public fun deleteUserResponse(userResponse: com.motiv.piotr.UserResponse): Int@Query("SELECT * FROM userResponse")
    @Transaction
    ...
    public fun saveUserResponses(userResponse: List<com.motiv.piotr.UserResponse>): Unit
}
